...
1. Download the latest release with the command:
   ...
   ```sh
   curl -LO https://github.com/samply/blazectl/releases/download/v0.17.1/blazectl-0.17.1-linux-amd64.tar.gz
   ```

1. Untar the binary:

   ```sh
   tar xzf blazectl-0.17.1-linux-amd64.tar.gz
   ```
...
1. Download the latest release with the command:
   ...
   ```sh
   curl -LO https://github.com/samply/blazectl/releases/download/v0.17.1/blazectl-0.17.1-darwin-amd64.tar.gz
   ```

1. Untar the binary:

   ```sh
   tar xzf blazectl-0.17.1-darwin-amd64.tar.gz
   ```
...
1. Download the latest release with the command:
   ...
   ```sh
   curl -LO https://github.com/samply/blazectl/releases/download/v0.17.1/blazectl-0.17.1-darwin-arm64.tar.gz
   ```

1. Untar the binary:

   ```sh
   tar xzf blazectl-0.17.1-darwin-arm64.tar.gz
   ```
...
1. Download the latest release with the command:
   ...
   ```sh
   curl -LO https://github.com/samply/blazectl/releases/download/v0.17.1/blazectl-0.17.1-linux-arm64.tar.gz
   ```

1. Untar the binary:

   ```sh
   tar xzf blazectl-0.17.1-linux-arm64.tar.gz
   ```
...
[3]: <https://github.com/samply/blazectl/releases/download/v0.17.1/blazectl-0.17.1-windows-amd64.zip>
