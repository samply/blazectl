...
1. Download the latest release with the command:
   ...
   ```bash
   curl -LO https://github.com/samply/blazectl/releases/download/v0.5.0/blazectl-0.5.0-linux-amd64.tar.gz
   ```

1. Untar the binary:

   ```bash
   tar xzf blazectl-0.5.0-linux-amd64.tar.gz
   ```
...
1. Download the latest release with the command:
   ...
   ```bash
   curl -LO https://github.com/samply/blazectl/releases/download/v0.5.0/blazectl-0.5.0-darwin-amd64.tar.gz
   ```

1. Untar the binary:

   ```bash
   tar xzf blazectl-0.5.0-darwin-amd64.tar.gz
   ```
...
[3]: <https://github.com/samply/blazectl/releases/download/v0.5.0/blazectl-0.5.0-windows-amd64.zip>
